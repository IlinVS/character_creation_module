...
def attack(char_name: str, char_class: str) -> str:
    """В зависимости от класса персонажа выводит наносимый урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """В зависимости от класса персонажа выводит очки блокирования урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """в зависимости от класса персонажа применяет специальные умения."""
    if char_class == 'warrior':
        return (
...
def choice_char_class() -> str:
    """Базовые настройки персонажа, выбор имени, класса."""
